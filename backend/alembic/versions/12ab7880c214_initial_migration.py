...
Revision ID: 12ab7880c214
Revises: 
Create Date: 2026-06-15 18:47:49.597164
...
def upgrade() -> None:
    ...
    sa.Column('accuracy_percentage', sa.Integer(), nullable=True),
    ...
    sa.Column('level_played', sa.Integer(), nullable=True),
